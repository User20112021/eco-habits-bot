...
HABITS = [
    ("water_teeth", "🚰 Выключал(а) воду при чистке зубов"),
    ("lights_off", "💡 Выключал(а) свет, выходя из комнаты"),
    ("no_cup", "🥤 Не пил(а) из одноразового стаканчика"),
    ("no_bag", "🛍️ Не использовал(а) пластиковый пакет"),
    ("trash_place", "🗑️ Складывал(а) мусор в отведённые места"),
    ("eco_move", "🚶 Пешком/экологичный транспорт вместо бензин-авто"),
]
